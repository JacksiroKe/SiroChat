...
class SettingsScreenState extends StatefulWidget {
  ...
  @override
  State createState() => SettingsScreenStateState();
}

class SettingsScreenStateState extends State<SettingsScreenState> {
  TextEditingController? controllerNickname, controllerAboutMe;
  ...
  Future uploadFile() async {
    ...
    try {
      ...
      settingProvider
          .updateDataFirestore(
              FirestoreConstants.pathUserCollection, id, user.toJson())
          .then((data) async {
